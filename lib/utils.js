...
exports.middlesWith = (str, element) => str ? str.includes(element) : false
...
exports.kittens = (num, cutenessFactor) => {
    // TODO: depreciate cutenessFactor as it is immutable at 11
    kittens = []
    for (i = num-1; i >= 0; i--) {
